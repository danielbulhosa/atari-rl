...
train_batch_size = 32
target_update_frequency = 16 * 100  # Multiplying by grad update freq lets us interpret the second number as epochs
action_repeat = 1  # The average episode length at the beginning is 9 steps, 4 repetitions would be half the episode...
gamma = 1
epoch_length = 1000
replay_buffer_size = 16 * 100  # Multiplying by grad update freq lets us interpret the second number as epochs
